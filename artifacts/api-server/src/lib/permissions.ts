...
export const SYSTEM_ROLES: SystemRoleDef[] = [
  ...
  { key: "marketing_manager", name: "Marketing Manager", description: "Runs marketing campaigns and analytics.", permissions: ["dashboard.view", "marketing.view", "marketing.manage", "inventory.view", "inventory.manage", "ai.read", "crm.view", "finance.view", "documents.view", "chat.read", "chat.write", "meetings.read", "meetings.create", "finance.manage"] },
  { key: "operations_manager", name: "Operations Manager", description: "Oversees orders, inventory and shipping.", permissions: ["dashboard.view", "orders.view", "orders.manage", "inventory.view", "inventory.manage", "shipping.view", "shipping.manage", "approvals.view", "finance.view", "chat.read", "chat.write", "meetings.read", "meetings.create", "finance.manage"] },
  { key: "sales_manager", name: "Sales Manager", description: "Manages customers and sales orders.", permissions: ["dashboard.view", "crm.view", "crm.manage", "orders.view", "marketing.view", "chat.read", "chat.write", "meetings.read", "meetings.create", "finance.view", "finance.manage"] },
  { key: "inventory_manager", name: "Inventory Manager", description: "Manages stock and products.", permissions: ["dashboard.view", "inventory.view", "inventory.manage", "orders.view", "chat.read", "chat.write", "meetings.read", "meetings.create", "finance.view", "finance.manage"] },
  { key: "shipping_manager", name: "Shipping Manager", description: "Manages shipments and returns.", permissions: ["dashboard.view", "shipping.view", "shipping.manage", "orders.view", "chat.read", "chat.write", "meetings.read", "meetings.create", "finance.view", "finance.manage"] },
  { key: "customer_support", name: "Customer Support", description: "Views customers and orders to help buyers.", permissions: ["dashboard.view", "crm.view", "orders.view", "finance.view", "chat.read", "chat.write", "callcenter.view", "meetings.read", "meetings.create", "finance.manage"] },
  ...
  { key: "director", name: "Director", description: "Company oversight: dashboard, finance, approvals and shareholder cap table.", permissions: ["dashboard.view", "finance.view", "treasury.view", "funds.view", "approvals.view", "approvals.manage", "shareholders.view", "documents.view", "chat.read", "chat.write", "chat.manage", "meetings.read", "meetings.create", "meetings.manage", "director.view", "finance.manage"] },
  ...
  { key: "shareholder", name: "Shareholder", description: "Views their own equity, cap table and investment history.", permissions: ["dashboard.view", "shareholders.view", "finance.view", "meetings.read", "finance.manage"] },
  {
    key: "staff",
    name: "Staff / Employee",
